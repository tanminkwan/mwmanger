...
* **`dateRegex`** (필수): 각 로그 라인의 선두에서 날짜/시간을 추출하기 위한 정규식입니다.
  ...
  * 예시: 로그가 `[2026.08.25 14:04:39] [ERROR] 메시지` 인 경우 정규식은 `\\[(\\d{4}\\.\\d{2}\\.\\d{2} \\d{2}:\\d{2}:\\d{2})\\]` 가 됩니다.
...
```json
{
  ...
  "additional_params": "{\"start\":\"2026.08.25 14:04:39\",\"end\":\"2026.08.25 14:04:43\",\"dateRegex\":\"\\\\[(\\\\d{4}\\\\.\\\\d{2}\\\\.\\\\d{2} \\\\d{2}:\\\\d{2}:\\\\d{2})\\\\]\",\"keywords\":[\"Exception\", \"Fail\"]}",
